...
public class Events {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == MellowVillagers.AGRONOMIST.get()) {
            Int2ObjectMap<List<VillagerTrades.ItemListing>> trades = event.getTrades();
            ItemStack stack = new ItemStack(ItemInit.CORN_SEEDS.get(), 1);
        ...
        if(event.getType() == MellowVillagers.AGRONOMIST.get()) {
            Int2ObjectMap<List<VillagerTrades.ItemListing>> trades = event.getTrades();
            ItemStack stack = new ItemStack(ItemInit.FLAX_CROP_SEEDS.get(), 1);
