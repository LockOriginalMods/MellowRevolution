...
public class MellowVillagers {
    ...
    public static final DeferredRegister<VillagerProfession> VILLAGER_PROFESSIONS =
            DeferredRegister.create(ForgeRegistries.PROFESSIONS, MOD_ID);

    public static final RegistryObject<PoiType> BLOCK_POI = POI_TYPES.register("block_poi", ()->
            new PoiType(ImmutableSet.copyOf(BlockInit.ZINC_BLOCK.get().getStateDefinition().getPossibleStates()),
                    1, 1));
